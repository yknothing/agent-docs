...
FEISHU_IMPORT_STDOUT_SNIPPET_MAX_LEN = 400
FEISHU_DOC_URL_BASE = "https://my.feishu.cn/docx/"
FEISHU_DOC_ROOT_MODE_DEFAULT = "agent-docs-folder"
FEISHU_DOC_ROOT_MODE_PARENT = "parent"
FEISHU_SYNC_FAIL_STATUSES = frozenset({"FAIL", "PARTIAL", "BLOCKED"})
FEISHU_SYNC_STATUS_SKIPPED = "SKIPPED"
FEISHU_SYNC_STATUS_BLOCKED = "BLOCKED"
FEISHU_SYNC_STATUS_FAIL = "FAIL"
FEISHU_SYNC_STATUS_PARTIAL = "PARTIAL"
FEISHU_SYNC_STATUS_DRY_RUN = "DRY_RUN"
FEISHU_ITEM_STATUS_OK_DRY_RUN = "ok-dry-run"

PIPELINE_OVERALL_STATUS_PASS = "PASS"
PIPELINE_OVERALL_STATUS_FAIL = "FAIL"
